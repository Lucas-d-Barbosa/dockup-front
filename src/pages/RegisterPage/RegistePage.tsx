  ...
  return (
    <section className={styles.sectionRegister}>
      <div className={styles.containerRegister}>
        <Form onSubmit={handleValidateInputs}>
          ...
          <div className={styles.containerInput}>
            ...
            <div className={styles.inputGroup}>
              <Label text="Email:" forID="email" classWidth={"max-w-md"} />
              <Input
                type="email"
            ...
            <div className={styles.inputGroup}>
              <Label text="Senha:" forID="password" classWidth={"max-w-md"} />
              <Input
                type="password"
      ...
      <div className={styles.containerText}>
        ...
        <h3>
          Crie sua conta e tenha acesso completo aos seus arquivos com total
          segurança
        </h3>
      </div>
    </section>
